...
//  so its relationships resolve to same-version types. The filter value types its Playlist embeds are
//  pinned as `LegacyFilter` copies for the same reason. AppStateModel/GlobalSettings/SchemaMarker
