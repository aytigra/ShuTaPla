...
//  drags the whole component, so its relationships resolve to same-version types. The value types its
//  Playlist stores are pinned as `Legacy` copies for the same reason;
